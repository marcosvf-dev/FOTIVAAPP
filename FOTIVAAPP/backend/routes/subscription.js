...
const PLANS = {
  starter: { name: 'Fotiva Starter', price: 19.90, priceId: process.env.STRIPE_PRICE_STARTER },
  normal:  { name: 'Fotiva Normal',  price: 39.90, priceId: process.env.STRIPE_PRICE_NORMAL },
  pro:     { name: 'Fotiva PRO',     price: 69.90, priceId: process.env.STRIPE_PRICE_PRO },
};
