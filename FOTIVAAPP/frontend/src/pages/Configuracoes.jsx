        ...
        {tab === 'notificacoes' && (
          <div style={cardStyle}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20 }}>
              <div style={{ width: 44, height: 44, borderRadius: 12, background: 'rgba(232,119,34,0.1)', border: '1px solid rgba(232,119,34,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            {notifStatus === 'granted' && pushActive && (
              <div style={{ background: 'rgba(34,197,94,.08)', border: '1px solid rgba(34,197,94,.2)', borderRadius: 10, padding: '10px 14px', marginBottom: 14, fontSize: 13, color: '#22C55E' }}>
                ✅ Notificações ativas — você receberá alertas dos eventos
              </div>
            )}
            {notifStatus === 'denied' && (
