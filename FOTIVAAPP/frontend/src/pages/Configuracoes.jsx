      ...
      <div style={{ maxWidth: 600, margin: '0 auto' }}>
        ...
        {tab === 'conta' && (
          <div style={cardStyle}>
            ...
            <div style={{ background: 'rgba(232,119,34,0.08)', border: '1px solid rgba(232,119,34,0.2)', borderRadius: 12, padding: 16, marginBottom: 20 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div>
                  <div style={{ color: '#E87722', fontWeight: 800, fontSize: 16 }}>Plano Normal</div>
                  <div style={{ color: '#666', fontSize: 13, marginTop: 2 }}>Dashboard · Agenda · Clientes · Financeiro</div>
                </div>
                <div style={{ textAlign: 'right' }}>
                  <div style={{ color: '#fff', fontWeight: 800, fontSize: 20 }}>R$29,90</div>
            ...
            <div style={{ background: 'rgba(168,85,247,0.08)', border: '1px solid rgba(168,85,247,0.2)', borderRadius: 12, padding: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                <div>
                  ...
                  <div style={{ color: '#666', fontSize: 13, marginTop: 2 }}>Tudo do Normal + Galeria com reconhecimento facial</div>
                </div>
                <div style={{ textAlign: 'right' }}>
              ...
              <button className="f-btn" style={{ width: '100%', padding: '10px', background: 'rgba(168,85,247,0.15)', color: '#A855F7', border: '1px solid rgba(168,85,247,0.3)', borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: 'pointer' }}>
